...
<script lang="ts">
    ...
    import type {
        ExplorePanel_Usage,
        ExplorePanel_UsagesResult,
        ExplorePanel_UsagesVariables,
    } from './ExplorePanel.gql'
    ...
    export let connection: InfinityQueryStore<ExplorePanel_UsagesResult, ExplorePanel_UsagesVariables> | undefined
