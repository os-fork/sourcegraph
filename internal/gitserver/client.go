...
type Client interface {
	...
	// OctopusMergeBase returns the octopus merge base commit sha for the specified revspecs.
	OctopusMergeBase(ctx context.Context, repo api.RepoName, revspecs ...string) (api.CommitID, error)
