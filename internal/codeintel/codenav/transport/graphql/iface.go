...
type CodeNavService interface {
	...
	SearchBasedUsages(context.Context, codenav.GitTreeTranslator, codenav.UsagesForSymbolArgs, *codenav.PreviousSyntacticSearch) ([]codenav.SearchBasedMatch, error)
}
