...
func NewMockCodeNavService() *MockCodeNavService {
	return &MockCodeNavService{
		...
		SearchBasedUsagesFunc: &CodeNavServiceSearchBasedUsagesFunc{
			defaultHook: func(context.Context, codenav.GitTreeTranslator, codenav.UsagesForSymbolArgs, *codenav.PreviousSyntacticSearch) (r0 []codenav.SearchBasedMatch, r1 error) {
				return
			},
		},
		SnapshotForDocumentFunc: &CodeNavServiceSnapshotForDocumentFunc{
...
func NewStrictMockCodeNavService() *MockCodeNavService {
	return &MockCodeNavService{
		...
		SearchBasedUsagesFunc: &CodeNavServiceSearchBasedUsagesFunc{
			defaultHook: func(context.Context, codenav.GitTreeTranslator, codenav.UsagesForSymbolArgs, *codenav.PreviousSyntacticSearch) ([]codenav.SearchBasedMatch, error) {
...
type CodeNavServiceSearchBasedUsagesFunc struct {
	defaultHook func(context.Context, codenav.GitTreeTranslator, codenav.UsagesForSymbolArgs, *codenav.PreviousSyntacticSearch) ([]codenav.SearchBasedMatch, error)
	hooks       []func(context.Context, codenav.GitTreeTranslator, codenav.UsagesForSymbolArgs, *codenav.PreviousSyntacticSearch) ([]codenav.SearchBasedMatch, error)
...
// stores the parameter and result values of this invocation.
func (m *MockCodeNavService) SearchBasedUsages(v0 context.Context, v1 codenav.GitTreeTranslator, v2 codenav.UsagesForSymbolArgs, v3 *codenav.PreviousSyntacticSearch) ([]codenav.SearchBasedMatch, error) {
...
// method of the parent MockCodeNavService instance is invoked and the hook
// queue is empty.
func (f *CodeNavServiceSearchBasedUsagesFunc) SetDefaultHook(hook func(context.Context, codenav.GitTreeTranslator, codenav.UsagesForSymbolArgs, *codenav.PreviousSyntacticSearch) ([]codenav.SearchBasedMatch, error)) {
	f.defaultHook = hook
}
...
// queue is empty, the default hook function is invoked for any future
// action.
func (f *CodeNavServiceSearchBasedUsagesFunc) PushHook(hook func(context.Context, codenav.GitTreeTranslator, codenav.UsagesForSymbolArgs, *codenav.PreviousSyntacticSearch) ([]codenav.SearchBasedMatch, error)) {
	f.mutex.Lock()
	f.hooks = append(f.hooks, hook)
	f.mutex.Unlock()
}
...
func (f *CodeNavServiceSearchBasedUsagesFunc) SetDefaultReturn(r0 []codenav.SearchBasedMatch, r1 error) {
	f.SetDefaultHook(func(context.Context, codenav.GitTreeTranslator, codenav.UsagesForSymbolArgs, *codenav.PreviousSyntacticSearch) ([]codenav.SearchBasedMatch, error) {
		return r0, r1
	})
}
...
func (f *CodeNavServiceSearchBasedUsagesFunc) PushReturn(r0 []codenav.SearchBasedMatch, r1 error) {
	f.PushHook(func(context.Context, codenav.GitTreeTranslator, codenav.UsagesForSymbolArgs, *codenav.PreviousSyntacticSearch) ([]codenav.SearchBasedMatch, error) {
		return r0, r1
	})
}

func (f *CodeNavServiceSearchBasedUsagesFunc) nextHook() func(context.Context, codenav.GitTreeTranslator, codenav.UsagesForSymbolArgs, *codenav.PreviousSyntacticSearch) ([]codenav.SearchBasedMatch, error) {
	f.mutex.Lock()
	defer f.mutex.Unlock()
...
type CodeNavServiceSearchBasedUsagesFuncCall struct {
	...
	// Arg3 is the value of the 4th argument passed to this method
	// invocation.
	Arg3 *codenav.PreviousSyntacticSearch
	// Result0 is the value of the 1st result returned from this method
	// invocation.
